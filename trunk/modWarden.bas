...
Public Function WardenClientData(Instance As Long, sData As String) As Boolean
  Dim ID As Long
  frmChat.AddChat vbWhite, "[Warden] WardenClientData(" & Instance & ", " & StrToHex(sData) & ")"
  ID = Asc(Mid(sData, 2, 1))
