...
Public Function ValidateXML(ByVal strXMLPath As String, ByVal strXSDPath As String) As Boolean
    ...
    Dim objSchemas As XMLSchemaCache40
    Dim objXML As DOMDocument40
    Dim objXSD As DOMDocument40
        ...
        For i = LBound(saElements) To UBound(saElements) Step 3
            ...
            If ((StrictIsNumeric(saElements(i + 1))) And (Len(saElements(i + 2)) > 0)) Then
                ...
                With rtb
                    ...
                    .SelText = _
                        saElements(i + 2) & Left$(vbCrLf, -2 * CLng((i + 2) = UBound(saElements)))
                ...
                ' ...
                If (LogThis) Then
                    Print #f, saElements(i + 2) & _
                        Left$(vbCrLf, -2 * CLng((i + 2) = UBound(saElements)));
                End If
            End If
        Next i
