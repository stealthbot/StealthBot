...
#Region "Static Methods"
    ...
    'UPGRADE_NOTE: clsCommandObj was upgraded to clsCommandObj_Renamed. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
    Public Shared Function GetCommands(Optional ByVal scriptName As String = vbNullString) As Collection
        Dim clsCommandObj_Renamed As Object
    ...
    Public Shared Function ValidateXMLFromFiles(ByVal strXMLPath As String, ByVal strXSDPath As String) As Object
    ...
    Public Shared Function ValidateXMLFromStrings(ByVal strXML As String, ByVal strXSD As String) As Boolean
