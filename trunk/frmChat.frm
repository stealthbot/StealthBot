    ...
    #If (BETA = 1) Then
        #If (DEV_RELEASE = 1) Then
            CVERSION = "StealthBot Beta v" & App.Major & "." & App.Minor & _
                ZeroOffsetEx(App.REVISION, 3) & " Development Release " & "38"
        #Else
            CVERSION = "StealthBot Beta v" & App.Major & "." & App.Minor & _
    ...
    Else
        ...
        With rtbWhispers
            If .Visible Then
                ...
                .Move rtbChat.Left, cboSend.Top + cboSend.Height, Me.ScaleWidth - cmdShowHide.Width - 10
            End If
        End With
...
'    End If
    ...
    '  BREAKS COMPILATION
    ' COMMENTED BACK IN 2009-1-03 Pyro6
    '  WORKING ON WARDEN AGAIN
...
Private Function GetClanSelectedUser() As String
    With lvClanList
        If Not (.SelectedItem Is Nothing) Then
            ...
            Else
                GetClanSelectedUser = reverseUsername(.SelectedItem.text)
            End If
        End If
    End With
End Function
