...
Module modPacketBuffer
	...
	Public Function CachePacket(ByRef Direction As modEnum.enuPL_DirectionTypes, ByRef PKT_Type As modEnum.enuPL_ServerTypes, ByRef ID As Byte, ByRef Length As Short, ByRef Data As String) As Object
	...
	Public Sub WritePacketData(ByVal Server As modEnum.enuPL_ServerTypes, ByVal Direction As modEnum.enuPL_DirectionTypes, ByVal PacketID As Integer, ByVal PacketLen As Integer, ByRef PacketData As String, Optional ByVal TimeDate As Date = #12:00:00 AM#)
