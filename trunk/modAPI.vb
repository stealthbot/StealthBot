...
Module modAPI
	...
	Public Declare Function EnumDisplayMonitors Lib "user32" (ByVal hDC As Integer, ByRef lprcClip As Any, ByVal lpfnEnum As Integer, ByRef dwData As Integer) As Integer
	
	'UPGRADE_ISSUE: Declaring a parameter 'As Any' is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="FAE78A8D-8978-4FD4-8208-5B7324A8F795"'
	Public Declare Function SetSockOpt Lib "ws2_32.dll"  Alias "setsockopt"(ByVal lSocketHandle As Integer, ByVal lSocketLevel As Integer, ByVal lOptName As Integer, ByRef vOptVal As Any, ByVal lOptLen As Integer) As Integer
	...
	'UPGRADE_ISSUE: Declaring a parameter 'As Any' is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="FAE78A8D-8978-4FD4-8208-5B7324A8F795"'
	Public Declare Function SendMessageAny Lib "user32"  Alias "SendMessageA"(ByVal hWnd As Integer, ByVal wMsg As Integer, ByVal wParam As Integer, ByRef lParam As Any) As Integer
	...
	'UPGRADE_ISSUE: Declaring a parameter 'As Any' is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="FAE78A8D-8978-4FD4-8208-5B7324A8F795"'
	Public Declare Sub ZeroMemory Lib "kernel32"  Alias "RtlZeroMemory"(ByRef Destination As Any, ByVal numBytes As Integer)
